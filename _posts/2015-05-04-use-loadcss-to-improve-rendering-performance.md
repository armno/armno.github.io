---
layout: post
title: "Case study: เปลี่ยนวิธีโหลด CSS เพื่อเพิ่ม Rendering Performance"
...
ทดสอบกับ YSlow ได้เกรด A

![ผลทดสอบกับ YSlow](/img/posts/loadcss/yslow-results.png)

ที่สำคัญคือลองโหลดเพจแล้วรู้สึกว่าเร็วขึ้นอย่างสัมผัสได้! (ถ้าไม่ได้คิดไปเองนะ) .. ลองเล่นกันดูได้ครับ ทำง่ายๆ ได้ที่บ้าน ไม่เสียเวลาเยอะอย่างที่คิด :P

[hyde-link]: http://hyde.getpoole.com/
