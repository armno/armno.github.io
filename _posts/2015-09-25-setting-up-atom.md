...
มีคนรู้สึกเหมือนกันเยอะ เลยมีคนทำ [`vim-mode-visual-block`](https://atom.io/packages/vim-mode-visual-block) package มา ลงคู่กับ vim-mode ทำให้ใช้ <kbd>Ctrl</kbd> + <kbd>p</kbd> ใช้งาน visual block mode ได้ครับ
