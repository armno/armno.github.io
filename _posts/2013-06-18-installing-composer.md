---
layout: blog
title: ติดตั้ง Composer บน OSX 10.7+
...
Composer นั้นใช้งานผ่าน command line ดังนั้นวันนี้เราจะมาทำให้ Mac OSX นั้นรู้จัก command <code>composer</code> กันครับ (ผมทดสอบบน OSX Lion (10.7) ที่ใช้อยู่) และต้องมี PHP 5.3.2+ และ <code>curl</code> ในเครื่องก่อนนะ
